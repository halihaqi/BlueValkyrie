...
Shader "UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_DistanceFade" {
    Properties {
        _FadeThreshold ("Threshold", Range(0,10)) = 2
...
//ToonCoreStart
        Pass {
            ...
            //相机渐变
            #pragma multi_compile _DISTANCE_FADE
